      ...
      <span className="home-page-app-description">
        <section>
          ...
          <p className="mission-text">
            AI Audio strives to make mastering services accessable to musicians
            by using AI to master their songs.
          </p>
        </section>
        ...
        <section>
          <div>
            <p className="what-is-mastering-text">
              Mastering is the final process that music undergoes before being
              published. We use mastering to ensure that your songs sound the
              same in every listening environment. In short, mastering takes WAV
              files and equalizes, compresses, limits, and enhances the sound
          ...
          <div className="waveform-and-description">
            ...
            <p className="mastering-explanation">
              WAV files are a lossless audio format. We use WAV files for our AI
              mastering process to ensure that the quality of audio is not
              degraded from being converted back and forth to a lossy format
              like mp3.
            </p>
          </div>
          <div className="heatmap-and-description">
            ...
            />
            <p className="mastering-explanation">
              When you upload a audio file a heatmap is created. The heatmap is
              a representation of all of the frequencies and their volume at any
              given point in the song.
            </p>
          </div>
        </section>
        <section>
          ...
          <p className="how-it-works-text">
            AI Audio uses a combination of Equalization, Stereo Polarization,
            and Limiting to match the heatmap of your song to the average
            heatmaps of thousands of industry standard songs.
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <p className="attribution-text">
            Thanks to Teragon audio for supplying a open source command-line VST
            plugin host.
          </p>

          <h4 className="attribution-header">Backgrounds</h4>
          <p className="attribution-text">
            Backgrounds supplied by FreePik. www.freepik.com
          </p>
        </section>
      </span>
    );
