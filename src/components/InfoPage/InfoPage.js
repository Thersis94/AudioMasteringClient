      ...
      <span className="home-page-app-description">
        ...
        <div className="img-and-description">
          ...
          <p className="mastering-explanation">
            ...
            representation of all of the frequencies and their volume at any
            given point in the song. The AI then uses a combination of
            Equalization, Stereo polarization, and Limiting to match the heatmap
            of your song to the average heatmaps of thousands of hit songs.
          </p>
        </div>
        <section>
